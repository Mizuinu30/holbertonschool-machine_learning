...
class Dataset:
    def __init__(self):
        """Initializes the Dataset class by loading and preparing the dataset."""
    ...
    def tokenize_dataset(self, data):
        ...
        tokenizer_pt = tokenizer_pt.train_new_from_iterator(pt_iterator(), 2**13)
        tokenizer_en = tokenizer_en.train_new_from_iterator(en_iterator(), 2**13)
